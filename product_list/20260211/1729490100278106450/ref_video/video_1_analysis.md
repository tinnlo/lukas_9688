...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Wed, 11 Feb 2026 16:41:35 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=78',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '8d43ca595557852a',
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:41:39 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=56',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '5b1baed9213cc2ed',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:41:56 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=60',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '554f6732c64ffd31',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:42:02 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=64',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '1f43485417f61b40',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Error when talking to Gemini API Full report available at: /var/folders/kt/j2l9r3892f1__8kc19n9dff00000gp/T/gemini-client-error-Turn.run-sendMessageStream-2026-02-11T16-42-13-564Z.json RetryableQuotaError: No capacity available for model gemini-3-flash-preview on the server
