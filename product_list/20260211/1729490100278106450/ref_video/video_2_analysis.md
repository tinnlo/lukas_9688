...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Wed, 11 Feb 2026 16:42:10 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=62',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '93c9214dc07f0481',
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:42:13 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=54',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '4c4d4120a9ba18ae',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:42:43 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=6214',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'f73dfbb925383a',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:42:52 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=5952',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '69367d8540f9f774',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:43:04 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=68',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '33d23a6b69ccd0',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:43:11 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=114',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '74d093d16cd1b9c',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Error when talking to Gemini API Full report available at: /var/folders/kt/j2l9r3892f1__8kc19n9dff00000gp/T/gemini-client-error-Turn.run-sendMessageStream-2026-02-11T16-43-22-172Z.json RetryableQuotaError: No capacity available for model gemini-3-flash-preview on the server
