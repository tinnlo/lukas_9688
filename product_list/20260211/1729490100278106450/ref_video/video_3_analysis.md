...
Attempt 1 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      date: 'Wed, 11 Feb 2026 16:41:28 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=52',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': '8eea79c62e754e6e',
...
Attempt 2 failed with status 429. Retrying with backoff... GaxiosError: [{
  ...
  response: {
    ...
    headers: {
      ...
      'content-length': '630',
      'content-type': 'application/json; charset=UTF-8',
      date: 'Wed, 11 Feb 2026 16:41:33 GMT',
      server: 'ESF',
      'server-timing': 'gfet4t7; dur=55',
      vary: 'Origin, X-Origin, Referer',
      'x-cloudaicompanion-trace-id': 'f16356c922e57437',
      'x-content-type-options': 'nosniff',
      'x-frame-options': 'SAMEORIGIN',
      'x-xss-protection': '0'
    },
...
Error when talking to Gemini API Full report available at: /var/folders/kt/j2l9r3892f1__8kc19n9dff00000gp/T/gemini-client-error-Turn.run-sendMessageStream-2026-02-11T16-41-52-081Z.json RetryableQuotaError: No capacity available for model gemini-3-flash-preview on the server
