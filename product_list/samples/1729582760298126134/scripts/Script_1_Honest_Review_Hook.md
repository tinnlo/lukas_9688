...
**Concept: The "Label Lie" Hook (Controversy + Trust)**

Opening with skepticism to build instant credibility, then revealing the surprising quality truth.

### Structure (45s)

- **Hook (0-3s):** Holding bottle, skeptical expression - "I thought cheap perfumes are scams"
- **Problem (3-15s):** "I always avoided budget fragrances... until TikTok showed me LASTAR"
- **Proof (15-35s):** Spray test, smell reaction, specific note breakdown (woody, spicy)
- **Social Proof (35-40s):** "My friends ask what I'm wearing every day"
- **CTA (40-45s):** "For this price, it's actually insane. Link below."

### Visual Strategy

| Seconds | Visual | Purpose |
|:--------|:-------|:--------|
| 00-02 | Creator holding bottle with surprised expression, close-up on label | Hook: Relatable skepticism creates curiosity |
| 02-05 | Quick cuts: cheap perfume bottles crossed out → LASTAR reveal | Problem: Budget fragrance stigma |
| 05-10 | Spray test in slow-mo against dark background (fine mist visible) | Proof: Atomizer quality = luxury |
| 10-15 | Close-up of creator smelling wrist, eyebrows raise, genuine smile | Emotional: Authentic positive reaction |
| 15-20 | Text overlay: "HOLZIG • WÜRZIG • MÄNNLICH" with ingredient visuals | Trust: Specificity overcomes doubt |
| 20-28 | Side-by-side: blurred expensive bottle vs. LASTAR (no brand shown) | Logic: Value comparison without violation |
| 28-33 | Creator in mirror adjusting collar, confident expression | Benefit: Personal transformation |
| 33-38 | B-roll: wood texture, coffee beans, leather jacket (scent visualization) | Sensory: Synesthesia trigger |
| 38-43 | Friend/partner leans in to smell neck, surprised face | Social Proof: External validation |
| 43-45 | Product hero shot + CTA overlay pointing to basket | Conversion: Clear next step |
